...
from aqterm import constants
from aqterm.schemes import ColorScheme
from aqterm.vt100 import Terminal
...
class TerminalWidget(QtWidgets.QWidget):
    keymap = {
       ...
       QtCore.Qt.Key.Key_Up: "~A",
       QtCore.Qt.Key.Key_Down: "~B",
       QtCore.Qt.Key.Key_Left: "~D",
       QtCore.Qt.Key.Key_Right: "~C",
       QtCore.Qt.Key.Key_PageUp: "~1",
       QtCore.Qt.Key.Key_PageDown: "~2",
       QtCore.Qt.Key.Key_Home: "~H",
       QtCore.Qt.Key.Key_End: "~F",
       QtCore.Qt.Key.Key_Insert: "~3",
       QtCore.Qt.Key.Key_Delete: "~4",
       QtCore.Qt.Key.Key_F1: "~a",
       QtCore.Qt.Key.Key_F2: "~b",
       QtCore.Qt.Key.Key_F3:  "~c",
       QtCore.Qt.Key.Key_F4:  "~d",
       QtCore.Qt.Key.Key_F5:  "~e",
       QtCore.Qt.Key.Key_F6:  "~f",
       QtCore.Qt.Key.Key_F7:  "~g",
       QtCore.Qt.Key.Key_F8:  "~h",
       QtCore.Qt.Key.Key_F9:  "~i",
       QtCore.Qt.Key.Key_F10:  "~j",
       QtCore.Qt.Key.Key_F11:  "~k",
    ...
    def updateGeometry(self):
        ...
        if self._columns > 0 and self._rows > 0:
            self.session.resize(self._columns, self._rows, self.width(), self.height())

    def resizeEvent(self, event):
        self.updateGeometry()
        self.terminal.set_size(self._columns, self._rows)
    ...
    def keyPressEvent(self, event):
        ...
        if ctrl and key == QtCore.Qt.Key.Key_Plus:
            self.zoom_in()
            ...
            if text and key != QtCore.Qt.Key.Key_Backspace:
                self.send(text)
            else:
